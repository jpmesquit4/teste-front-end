...
export default function App() {
  ...
  return (
    <>
          ...
          <main>
              <div className='ImageOffer-50Off' style={{ backgroundImage: "url('src/assets/images/RectangleOffer50.png')"}}>
              <div className='Shadow-ImageOffer-50Off'></div>

              <div className='Texts-ImageOffer-50Off'>
                    <h1>Venha conhecer nossas promoções</h1>
                    <p>50% Off <span>nos produtos</span> </p>
                    <button aria-label="Ver produto com 50% off">Ver produto</button>
              </div>
          </div>
          ...
          <div className="Section-Partnership">
              <div className='Partnership' style={{ backgroundImage: "url('src/assets/images/Partnership.png')" }}>
                  <div className='Shadow-Partnership'></div>

                  <div className='Partnership-Info'>
                        <h3>Parceiros</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur</p>
                        <button aria-label="Confira alguns de nosso parceiros">Confira</button>
                  </div>
